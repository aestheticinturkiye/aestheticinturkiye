...
public class JwtConfiguration {
    ...
    public JwtParser accessTokenParser() {
        return Jwts.parserBuilder()
                .setSigningKey(jwtProperties.getAccess().getSecret().getKey())
                .build();
    }
    ...
    public JwtParser refreshTokenParser() {
        return Jwts.parserBuilder()
                .setSigningKey(jwtProperties.getRefresh().getSecret().getKey())
                .build();
    }
    ...
    public JwtBuilder accessTokenBuilder() {
        return Jwts.builder()
                .signWith(jwtProperties.getAccess().getSecret().getKey());
    }

    @Bean("refreshTokenBuilder")
    public JwtBuilder refreshTokenBuilder() {
        return Jwts.builder()
                .signWith(jwtProperties.getRefresh().getSecret().getKey());
    }
